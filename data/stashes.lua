return {
	...
	{
		coords = vec3(891.495544, -1029.398926, 34.725616),
		target = {
			loc = vec3(891.495544, -1029.398926, 34.725616),
			length = 1.0,
			width = 1.0,
			heading = 0,
			minZ = 34.2,
		...
		name = 'gwa_waschtresor',
		label = 'Tresor Waschsalon',
		owner = false,
		slots = 6,
		weight = 50000,
		groups = {['gwa'] = 4}
	...
	{
		coords = vec3(14.048, -1596.197, 29.391),
		target = {
			loc = vec3(14.048, -1596.197, 29.391),
			length = 1.5,
			width = 1.5,
			heading = 0,
			minZ = 28.2,
		...
		name = 'ttf_kuehlschrank',
		label = 'Kühlschrank Taco Farmer',
		owner = false,
		slots = 30,
		weight = 800000,
		groups = {['ttf'] = 1}
	...
	{
		coords = vec3(12.024, -1598.324, 28.591),
		target = {
			loc = vec3(12.024, -1598.324, 28.591),
			length = 1.5,
			width = 1.5,
			heading = 0,
			minZ = 27.2,
